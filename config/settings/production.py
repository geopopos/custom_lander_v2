...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["vupautomations.com"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Custom Lander Creator V2 <noreply@vupautomations.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    ...
    default="[Custom Lander Creator V2] ",
)
...
SPEEDYINDEX_API_KEY = env("SPEEDYINDEX_API_KEY", default=None)
